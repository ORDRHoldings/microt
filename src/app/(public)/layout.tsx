  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 right-6 z-50 animate-fadeUp" style={{ animationDelay: '1s' }}>
        <a
          href="/book"
          className="group flex items-center justify-center gap-2 bg-gradient-to-r from-gold to-gold-light text-white font-bold text-sm tracking-widest uppercase px-6 py-4 rounded-full shadow-glow hover:shadow-glow-lg transition-all duration-300 hover:scale-105"
        >
